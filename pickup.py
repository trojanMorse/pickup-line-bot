...
updater = Updater(
    token='1514143854:AAE4wLXMmDFhuclCC-XXGl9PFmC02_aHX38', use_context=True)
...
def help(update, context):
    context.bot.send_message(chat_id=update.effective_chat.id, text="Daddy has sent me to take care of you"+emoji.emojize(':face_with_symbols_on_mouth:')+"." +
